...
jsPsych.plugins["coin-toss"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var trial_number = trial.trial_number + 1;
    ...
    var pattern_options = ['Definitely<br>random', 'Probably<br>random', 'Maybe<br>random', 'Maybe<br>determined', 'Probably<br>determined', 'Definitely<br>determined'];
    ...
    var css = '<style>';
    css += '#trial-number {margin-bottom: 20px}';
    css += '#toss {width: 600px; font-size: 60px; margin: auto}';
    ...
    var html = '<div id="trial-number">Here is sequence number '+trial_number+'</div>';
    html += '<div id="toss">';
    html += '</div>';
    html += '<div id="choice-container">';
    html += '<p class="coin-instructions">Do you think this looks random or looks determined?</p>';
